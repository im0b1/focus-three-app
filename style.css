...
:root {
    ...
    --auth-btn-bg-dark: var(--button-secondary-bg-dark); --auth-btn-text-dark: var(--auth-btn-text-dark);
    --auth-btn-hover-bg-dark: var(--auth-btn-hover-bg-dark);
...
body.dark-theme {
    ...
    --app-mode-toggle-bg: var(--app-mode-toggle-bg-dark);
    --app-mode-toggle-text: var(--app-mode-toggle-text-dark);
...
/* --- Toast Message Styles (v1.13.1-toast-message) --- */
#toast-container {
    position: fixed;
    bottom: 20px;
    left: 50%;
...
/* Type-specific colors for toasts */
.toast-info {
    background-color: var(--button-primary-bg);
    color: var(--button-text-color);
}
